...
def train_bert():
    templist =[]
    data = json.loads(open(r"C:\Users\jcsan\PycharmProjects\Mac1\CNS\LanguageCortex\Learning\FunctionalIntents.json").read())
    ...
    torch.save(model,
               r"C:\Users\jcsan\PycharmProjects\Mac1\CNS\LanguageCortex\Learning\Unsupervised\BertModel.pt")
...
def load_bert():
    return torch.load(r"C:\Users\jcsan\PycharmProjects\Mac1\CNS\LanguageCortex\Learning\Unsupervised\BertModel.pt")
